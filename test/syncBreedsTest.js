...
describe("#breedDetails", () => {
  ...
  it("returns undefined when for a nonexistent breed", () => {
    const nonexistent = breedDetails("Tabby");
    assert.equal(undefined, nonexistent);
  });
});
